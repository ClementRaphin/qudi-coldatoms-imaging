...
setup(
    ...
    description='LKB Atom Chips modules for cold atom detection',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://quantumdevices.fr/',
    ...
    classifiers=['Development Status :: 1 - Under Development',
